...
impl FanCurveDevice {
    pub(crate) fn to_byte(&self) -> u8 {
        match self {
            ...
            FanCurveDevice::System => 0x32, // 假设System风扇的设备ID为0x26
        }
    }
}
    ...
    pub fn min_percentage_inclusive(&self, device: FanCurveDevice) -> u8 {
        match self.0 {
            ...
            4 => match device {
                ...
                FanCurveDevice::System => 31, // System风扇与CPU风扇相同最小值
            },
            5 => match device {
                FanCurveDevice::Cpu => 49,
                FanCurveDevice::Gpu => 51,
                FanCurveDevice::System => 49, // System风扇与CPU风扇相同最小值
            },
            6 | 7 => match device {
                FanCurveDevice::Cpu => 56,
                FanCurveDevice::Gpu => 61,
                FanCurveDevice::System => 56, // System风扇与CPU风扇相同最小值
            },
